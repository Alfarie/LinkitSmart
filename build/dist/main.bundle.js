...
var SocketService = (function () {
    function SocketService(router, connectionguard) {
        var _this = this;
        this.router = router;
...
var DataComponent = (function () {
    ...
    DataComponent.prototype.checkDate = function (month, year) {
        ...
        var y = year - 2000;
        var str = m + y;
        this.http.get("/api/checkdate?my=" + str)
...
var GraphComponent = (function () {
    ...
    GraphComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            ...
            _this.http.get("/api/getdata?date=" + filename)
                .subscribe(function (data) {
                _this.sensorsData = data.json();
                _this.initSoil();
                _this.initLight();
...
var TableComponent = (function () {
    ...
    TableComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            // console.log(params);
            _this.filename = params['filename'];
            _this.http.get("/api/getdata?date=" + _this.filename)
                .subscribe(function (data) {
