...
(function() {
    ...
    function Ba(a, c) { return a - c }

    function La(a, c) { return a.x - c.x }
    ...
    function u(a) { return null === a || "undefined" === typeof a }

    function ta(a) { a.indexOf || (a.indexOf = Sa); return a }
    ...
    function N(a, c, b) { return a in c ? c[a] : b[a] }
    ...
    function Ta(a) {
        if (!na) {
            var c = !1,
                b = !1;
            "undefined" === typeof S.Chart.creditHref ? (a.creditHref = "", a.creditText =
    ...
    function Da(a, c, b) {
        if (a && c && b) {
            ...
            if ("undefined" !== typeof Blob && new Blob) {
                ...
                c = new Blob([m.buffer], { type: "image/" + c });
                try {
                    window.navigator.msSaveBlob(c,
                        b), f = !0
                } catch (l) { g.dataset.downloadurl = [d, g.download, g.href].join(":"), g.href = window.URL.createObjectURL(c) }
            }
    ...
    function wa() { for (var a = null, c = 0; c < arguments.length; c++) a = arguments[c], a.style && (a.style.display = "inline") }
    ...
    function z(a, c) {
        ...
        if (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) {
            ...
            this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ka(this.ctx), w ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ia(d, f), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas),
                ...
                this.toolTip = new R(this, this.options.toolTip), this.data = null, this.axisX = [], this.axisX2 = [], this.axisY = [], this.axisY2 = [], this.sessionVariables = { axisX: [], axisX2: [], axisY: [], axisY2: [] })
    ...
    function xa(a, c) {
        for (var b = [], d, f = 0; f < a.length; f++)
            if (0 == f) b.push(a[0]);
                ...
                var h = (a[k].x - a[g].x) / d;
                d = (a[k].y - a[g].y) / d;
                b[b.length] = a[m].x > a[g].x && 0 < h || a[m].x < a[g].x && 0 > h ? { x: a[m].x + h / 3, y: a[m].y + d / 3 } : { x: a[m].x, y: a[m].y + d / 9 };
                m = f;
                g = 0 === m ? 0 : m - 1;
                k = m === a.length - 1 ? m : m + 1;
    ...
    function pa(a, c) {
        ...
        if (u(this.options.margin) && a.options.subtitles)
            for (var b = a.options.subtitles, d = 0; d < b.length; d++)
                if ((u(b[d].horizontalAlign) && "center" === this.horizontalAlign || b[d].horizontalAlign === this.horizontalAlign) && (u(b[d].verticalAlign) && "top" === this.verticalAlign || b[d].verticalAlign === this.verticalAlign) && !b[d].dockInsidePlotArea === !this.dockInsidePlotArea) { this.margin = 0; break }
    ...
    var t = {},
        ...
        ka = {
            theme1: {
                ...
                Title: { fontFamily: w ? "Calibri, Optima, Candara, Verdana, Geneva, sans-serif" : "calibri", fontSize: 33, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "top", margin: 5 },
                Subtitle: {
                ...
                Legend: { verticalAlign: "bottom", horizontalAlign: "center", fontFamily: w ? "monospace, sans-serif,arial black" : "calibri" },
                DataSeries: {
            ...
            theme2: {
                ...
                Legend: { verticalAlign: "bottom", horizontalAlign: "center", fontFamily: w ? "monospace, sans-serif,arial black" : "arial" },
                DataSeries: {
                    indexLabelFontColor: "grey",
            ...
            theme3: {
                Chart: { colorSet: "colorSet1" },
                Title: { fontFamily: w ? "Candara, Optima, Trebuchet MS, Helvetica Neue, Helvetica, Trebuchet MS, serif" : "calibri", fontSize: 32, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "top", margin: 5 },
                Subtitle: { fontFamily: w ? "Candara, Optima, Trebuchet MS, Helvetica Neue, Helvetica, Trebuchet MS, serif" : "calibri", fontSize: 16, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "top", margin: 5 },
                Axis: {
                    titleFontSize: 22,
                    titleFontColor: "rgb(98,98,98)",
        ...
        E = { numberDuration: 1, yearDuration: 314496E5, monthDuration: 2592E6, weekDuration: 6048E5, dayDuration: 864E5, hourDuration: 36E5, minuteDuration: 6E4, secondDuration: 1E3, millisecondDuration: 1, dayOfWeekFromInt: "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ") },
        Na = {},
        ea = null,
        Ga = function() {
        ...
        fa = function(a, c, b) {
            ...
            for (var y = 0; m && y < m.length; y++)
                if (c = m[y], "." === c && 0 > h) h = y;
                    ...
                    if ("%" === c) k *= 100;
                    else if ("\u2030" === c) { k *= 1E3; continue } else if ("," === c[0] && "." === c[c.length - 1]) {
            ...
            else "E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || !/[eE][+-]*[0]+/.test(c) ? "," === c ? (y++, m = r, r = 0, 0 < k.length && (b = g + b)) : b = 1 < c.length && ('"' === c[0] && '"' === c[c.length - 1] || "'" === c[0] && "'" === c[c.length - 1]) ? c.slice(1, c.length - 1) + b : c + b : (c = 0 > s ? c.replace("+", "").replace("-", "") : c.replace("-", ""), b += c.replace(/[0]+/, function(a) { return Q(s, a.length) }));
            g = "";
            for (l = !1; 0 < p.length;) c = p.shift(), "#" === c || "0" === c ? 0 < a.length && 0 !== Number(a.join("")) ? (g += a.shift(),
                l = !0) : "0" === c && (g += "0", l = !0) : 1 < c.length && ('"' === c[0] && '"' === c[c.length - 1] || "'" === c[0] && "'" === c[c.length - 1]) ? g += c.slice(1, c.length - 1) : "E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || !/[eE][+-]*[0]+/.test(c) ? g += c : (c = 0 > s ? c.replace("+", "").replace("-", "") : c.replace("-", ""), g += c.replace(/[0]+/, function(a) { return Q(s, a.length) }));
            b += (l ? f : "") + g;
            return d ? "-" + b : b
        },
        Aa = function(a) {
    ...
    (function() {
        function a(a) {
            ...
            if (f && 0 < f.length || b) {
                ...
                b && (m = b);
                g = { ckVal: Number(k[0]), lSVal: m ? Number(m.val) : null };
                b = null;
                ...
                new Date, b = a.getTime(), a.setTime(b + 31536E6), b = { name: t.ckDec(t.str.ckn), val: (new Date).getTime() }, document.cookie = t.ckDec(t.str.ckn) + "=" + (new Date).getTime() + "; " + t.ckDec(t.str.ckve) + a.toUTCString() + "; path=/;", localStorage.setItem("lclStg", JSON.stringify(b));
            return !1
        }
        t.fSDec = function(a) { for (var b = "", d = 0; d < a.length; d++) b += String.fromCharCode(a[d] - 111); return b };
        t.str = {
        ...
        t.pro = { sCH: S[t.fSDec([178, 215, 208, 225, 227])][t.fSDec([210, 225, 212, 211, 216, 227, 183, 225, 212, 213])] };
        t.fAWm = function(c) {
        ...
        t.ckDec = function(a) { for (var b = "", d = 0; d < a.length; d++) b += String.fromCharCode(a[d] - 111); return b };
        t.str.ckn = [206, 206,
    ...
    K.prototype.isBeingTracked = function(a) { this.options._oldOptions || (this.options._oldOptions = {}); return this.options._oldOptions[a] ? !0 : !1 };
    K.prototype.hasOptionChanged = function(a) {
        if (!this.sessionVariables) throw "Session Variable Store not set";
        return this.sessionVariables[a] !== this.options[a]
    };
    K.prototype.addEventListener = function(a, c, b) { a && c && (this._eventListeners[a] = this._eventListeners[a] || [], this._eventListeners[a].push({ context: b || this, eventHandler: c })) };
    ...
    K.prototype.removeAllEventListeners = function() { this._eventListeners = [] };
    K.prototype.dispatchEvent =
        function(a, c, b) { if (a && this._eventListeners[a]) { c = c || {}; for (var d = this._eventListeners[a], f = 0; f < d.length; f++) d[f].eventHandler.call(d[f].context, c) } "function" === typeof this[a] && this[a].call(b || this.chart, c) };
    T(z, K);
    ...
    z.prototype._updateOptions = function() {
        ...
        if (!this._dropdownMenu && this.exportEnabled && w) {
            ...
            L(c, "mouseover", function() { this.style.backgroundColor = "#EEEEEE" }, !0);
            L(c, "mouseout", function() { this.style.backgroundColor = "transparent" }, !0);
            L(c, "click", function() {
                a.print();
                ba(a._dropdownMenu)
            }, !0);
            ...
            for (var c = 0; c < this.options.data.length; c++)
                if (a++, !this.options.data[c].type || 0 <= z._supportedChartTypes.indexOf(this.options.data[c].type)) {
                    ...
                    "bubble" !== b.type && "scatter" !== b.type || !b.dataPoints || (b.dataPoints.some ?
                        b.dataPoints.some(function(a) { return a.x }) && b.dataPoints.sort(La) : b.dataPoints.sort(La));
                    this.data.push(b);
    ...
    z.prototype.render = function(a) {
        ...
        if (0 < this._axes.length && (this.zoomEnabled || this.panEnabled))
            for (a = 0; a < this._axes.length; a++)
                if (null !== this._axes[a].viewportMinimum || null !== this._axes[a].viewportMaximum) { b = !0; break }
                    ...
                    if (!(d < y) || n) {
                        ...
                        if (b.viewPortMin === d && f)
                            for (A = 0; A < f.length; A++)
                                if (null === f[A] && q < d) { b.viewPortMin = q; break }
    ...
    z.prototype.getAutoFontSize = function(a, c, b) { a /= 400; return Math.max(10, Math.round(Math.min(this.width, this.height) * a)) };
    z.prototype.resetOverlayedCanvas = function() { this.overlaidCanvasCtx.clearRect(0, 0, this.width, this.height) };
    z.prototype.clearCanvas = function() {
        this.ctx.clearRect(0, 0, this.width, this.height);
        this.backgroundColor && (this.ctx.fillStyle = this.backgroundColor, this.ctx.fillRect(0, 0, this.width, this.height))
    };
    z.prototype.attachEvent = function(a) { this._events.push(a) };
    ...
    z.prototype._dispatchRangeEvent = function(a, c) {
        ...
        for (var f = 0; f < d.length; f++)
            ...
            for (g = 0; g < this.axisY2.length; g++) b[d[f]].push({ viewportMinimum: this[d[f]][g].sessionVariables.newViewportMinimum, viewportMaximum: this[d[f]][g].sessionVariables.newViewportMaximum });
        else if ("axisX" === d[f])
            ...
            for (g =
                0; g < this.axisX2.length; g++) b[d[f]].push({ viewportMinimum: this[d[f]][g].sessionVariables.newViewportMinimum, viewportMaximum: this[d[f]][g].sessionVariables.newViewportMaximum });
    ...
    z.prototype._plotAreaMouseMove = function(a, c) {
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            if ((!f || 2 < Math.abs(b) || !g || 2 < Math.abs(d)) && (this.panEnabled || this.zoomEnabled))
                if (this.panEnabled) f = { x1: f ? this.plotArea.x1 + b : this.plotArea.x1, y1: g ? this.plotArea.y1 + d : this.plotArea.y1, x2: f ? this.plotArea.x2 + b : this.plotArea.x2, y2: g ? this.plotArea.y2 + d : this.plotArea.y2 }, clearTimeout(k._panTimerId), k._panTimerId = setTimeout(function(b, d, e, f) {
                    return function() {
    ...
    z.prototype.validateRegion = function(a, c, b, d, f) {
        ...
        for (g = 0; g < l.length; g++) {
            var k = l[g],
                n = k.convertPixelToValue({ x: a, y: c }),
                e = k.convertPixelToValue({ x: b, y: d });
            if (n > e) var q = e,
                e = n,
                n = q;
            if (isFinite(k.dataInfo.minDiff))
                if (!(k.logarithmic && e / n < Math.pow(k.dataInfo.minDiff, 3) || !k.logarithmic && Math.abs(e - n) < 3 * Math.abs(k.dataInfo.minDiff) || n < k.minimum || e > k.maximum)) h.push(k), p.push({ val1: n, val2: e }), m = !0;
                else if (!f) { m = !1; break }
        }
        return { isValid: m, axesWithValidRange: h, axesRanges: p }
    };
    ...
    z.prototype.renderIndexLabels = function(a) {
        ...
        for (a = 0; a < this._indexLabels.length; a++) {
            ...
            if (l.dataSeries.indexLabelFormatter || l.dataPoint.indexLabelFormatter) A = { chart: this, dataSeries: l.dataSeries, dataPoint: l.dataPoint, index: l.indexKeyword, total: v.total, percent: v.percent };
            ...
            if (null !== x && "" !== x) {
                var v = N("indexLabelPlacement", l.dataPoint, l.dataSeries),
                    ...
                    z = !1,
                    q = new W(c, { x: 0, y: 0, maxWidth: f ? f : 0.5 * this.width, maxHeight: g ? 5 * h : 1.5 * h, angle: "horizontal" === A ? 0 : -90, text: x, padding: 0, backgroundColor: q, horizontalAlign: "left", fontSize: h, fontFamily: n, fontWeight: k, fontColor: m, fontStyle: e, textBaseline: "top" });
                q.measureText();
                l.dataSeries.indexLabelMaxWidth = q.maxWidth;
                if ("stackedarea100" === p) { if (l.point.x < b.x1 || l.point.x > b.x2 || l.point.y < b.y1 - 1 || l.point.y > b.y2 + 1) continue } else if ("rangearea" === p || "rangesplinearea" === p) {
                    if (l.dataPoint.x <
                ...
                } else if (0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("bubble") || 0 <= p.indexOf("scatter")) { if (l.dataPoint.x < t.viewportMinimum || l.dataPoint.x > t.viewportMaximum || l.dataPoint.y < D.viewportMinimum || l.dataPoint.y > D.viewportMaximum) continue } else if (0 <= p.indexOf("column")) {
                    if (l.dataPoint.x < t.viewportMinimum || l.dataPoint.x > t.viewportMaximum ||
                        l.bounds.y1 > b.y2 || l.bounds.y2 < b.y1) continue
                } else if (0 <= p.indexOf("bar")) { if (l.dataPoint.x < t.viewportMinimum || l.dataPoint.x > t.viewportMaximum || l.bounds.x1 > b.x2 || l.bounds.x2 < b.x1) continue } else if ("candlestick" === p || "ohlc" === p) { if (l.dataPoint.x < t.viewportMinimum || l.dataPoint.x > t.viewportMaximum || Math.max.apply(null, l.dataPoint.y) < D.viewportMinimum || Math.min.apply(null, l.dataPoint.y) > D.viewportMaximum) continue } else if (l.dataPoint.x < t.viewportMinimum || l.dataPoint.x > t.viewportMaximum) continue;
                f = k = 2;
                "horizontal" ===
        ...
        c = { source: c, dest: this.plotArea.ctx, animationCallback: F.fadeInAnimation, easingFunction: F.easing.easeInQuad, animationBase: 0, startTimePercent: 0.7 };
                    ...
                    for (var A = !1, s = 0; s < h.length; s++)
                        if (y = h[s].x.getTime ? h[s].x.getTime() : h[s].x, !(y < a.axisX.dataInfo.viewPortMin || y > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !A)))
                            if ("number" !== typeof h[s].y) 0 < s && !(m.connectNullData || A || r) && (c.stroke(),
                                ...
                                this._eventManager.objectMap[x] = { id: x, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: s, x1: y, y1: v };
                                ...
                                if (0 < h[s].markerSize || 0 < m.markerSize) {
                                    ...
                                    d.push(J);
                                    x = G(x);
                                    w && d.push({ x: y, y: v, ctx: b, type: J.type, size: J.size, color: x, borderColor: x, borderThickness: J.borderThickness })
                                }(h[s].indexLabel || m.indexLabel || h[s].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "line", dataPoint: h[s], dataSeries: m, point: { x: y, y: v }, direction: 0 > h[s].y === a.axisY.reversed ? 1 : -1, color: e })
                            }
                    c.stroke();
                    w && b.stroke()
                }
    ...
    z.prototype.renderStepLine = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    for (var A = !1, s = 0; s < h.length; s++)
                        if (y = h[s].getTime ? h[s].x.getTime() : h[s].x, !(y < a.axisX.dataInfo.viewPortMin || y > a.axisX.dataInfo.viewPortMax &&
                            ...
                            if ("number" !== typeof h[s].y) 0 < s && !(m.connectNullData || A || r) && (c.stroke(), w && b.stroke()), A = !0;
                                ...
                                this._eventManager.objectMap[J] = { id: J, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: s, x1: y, y1: v };
                                ...
                                if (0 < h[s].markerSize || 0 < m.markerSize) x = m.getMarkerProperties(s, y, v, c), d.push(x), J = G(J), w && d.push({ x: y, y: v, ctx: b, type: x.type, size: x.size, color: J, borderColor: J, borderThickness: x.borderThickness });
            ...
            c.beginPath();
            w && b.beginPath();
            return { source: c, dest: this.plotArea.ctx, animationCallback: F.xClipAnimation, easingFunction: F.easing.linear, animationBase: 0 }
        }
    };
                    ...
                    for (y = !1, r = 0; r < h.length; r++)
                        if (s = h[r].getTime ? h[r].x.getTime() : h[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !y)))
                            if ("number" !== typeof h[r].y) 0 < r && !y &&
                                ...
                                this._eventManager.objectMap[A] = { id: A, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: r, x1: s, y1: y };
                                v[v.length] = { x: s, y: y };
                                ...
                                if (0 < h[r].markerSize || 0 < m.markerSize) {
                                    ...
                                    f.push(x);
                                    A = G(A);
                                    w && f.push({ x: s, y: y, ctx: d, type: x.type, size: x.size, color: A, borderColor: A, borderThickness: x.borderThickness })
                ...
                if (0 < e.length)
                    for (var q = 5 < p && n.bevelEnabled ? !0 : !1, f = 0; f < e.length; f++)
                        if (e[f].getTime ? m = e[f].x.getTime() : m = e[f].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                            ...
                            b = n.dataPointIds[f];
                            this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: l, dataPointIndex: f, x1: g, y1: k, x2: r, y2: s };
                            b = G(b);
                            ...
                            this._indexLabels.push({ chartType: "column", dataPoint: e[f], dataSeries: n, point: { x: g + (r - g) / 2, y: 0 > e[f].y === a.axisY.reversed ? k : s }, direction: 0 > e[f].y === a.axisY.reversed ? 1 : -1, bounds: { x1: g, y1: Math.min(k, s), x2: r, y2: Math.max(k, s) }, color: b })
                        }
            }
            c.restore();
            w && this._eventManager.ghostCtx.restore();
            return { source: c, dest: this.plotArea.ctx, animationCallback: F.yScaleAnimation, easingFunction: F.easing.easeOutQuart, animationBase: h < a.axisY.bounds.y1 ? a.axisY.bounds.y1 : h > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : h }
        }
    };
                    ...
                    if (0 < r.length) {
                        ...
                        for (m = 0; m < r.length; m++)
                            if (b = r[m].x.getTime ? r[m].x.getTime() : r[m].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[m].y) {
                                ...
                                (r[m].indexLabel || q.indexLabel || r[m].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedColumn", dataPoint: r[m], dataSeries: q, point: { x: d, y: 0 <= r[m].y ? h : A }, direction: 0 > r[m].y === a.axisY.reversed ? 1 : -1, bounds: { x1: y, y1: Math.min(h, A), x2: v, y2: Math.max(h, A) }, color: b })
                            }
                    }
                }
                c.restore();
    ...
    z.prototype.renderStackedColumn100 = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                if (0 < r.length)
                    for (var s = 5 < n && q.bevelEnabled ?
                        ...
                        if (b = r[m].x.getTime ? r[m].x.getTime() : r[m].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[m].y) {
                            ...
                            O(c, y, h, v, A, b, 0, null, s && 0 <= r[m].y, 0 > r[m].y && s, !1, !1, q.fillOpacity);
                            b = q.dataPointIds[m];
                            this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: e, dataPointIndex: m, x1: y, y1: h, x2: v, y2: A };
                            b = G(b);
                            w && O(this._eventManager.ghostCtx, y, h, v, A, b, 0, null, !1, !1, !1, !1);
                            (r[m].indexLabel || q.indexLabel || r[m].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                dataPoint: r[m],
                                dataSeries: q,
                                point: { x: d, y: 0 <= r[m].y ? h : A },
                                direction: 0 > r[m].y === a.axisY.reversed ? 1 : -1,
                                bounds: { x1: y, y1: Math.min(h, A), x2: v, y2: Math.max(h, A) },
                                color: b
                            })
                        }
            }
            c.restore();
            w && this._eventManager.ghostCtx.restore();
            return { source: c, dest: this.plotArea.ctx, animationCallback: F.yScaleAnimation, easingFunction: F.easing.easeOutQuart, animationBase: l < a.axisY.bounds.y1 ? a.axisY.bounds.y1 : l > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : l }
        }
    };
                ...
                if (0 < e.length) {
                    ...
                    for (f = 0; f < e.length; f++)
                        if (e[f].getTime ? m = e[f].x.getTime() : m = e[f].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                            ...
                            b = n.dataPointIds[f];
                            this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: l, dataPointIndex: f, x1: s, y1: k, x2: g, y2: r };
                            b = G(b);
                            w && O(this._eventManager.ghostCtx, s,
                                k, g, r, b, 0, null, !1, !1, !1, !1);
                            (e[f].indexLabel || n.indexLabel || e[f].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({ chartType: "bar", dataPoint: e[f], dataSeries: n, point: { x: 0 <= e[f].y ? g : s, y: k + (r - k) / 2 }, direction: 0 > e[f].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(s, g), y1: k, x2: Math.max(s, g), y2: r }, color: b })
                        }
                }
            }
            c.restore();
    ...
    z.prototype.renderStackedBar = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                if (0 < r.length) {
                    ...
                    for (m = 0; m < r.length; m++)
                        if (b = r[m].x.getTime ? r[m].x.getTime() : r[m].x, !(b <
                            ...
                            b = q.dataPointIds[m];
                            this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: e, dataPointIndex: m, x1: A, y1: y, x2: h, y2: v };
                            b = G(b);
            ...
            c.restore();
            w && this._eventManager.ghostCtx.restore();
            return { source: c, dest: this.plotArea.ctx, animationCallback: F.xScaleAnimation, easingFunction: F.easing.easeOutQuart, animationBase: l < a.axisY.bounds.x1 ? a.axisY.bounds.x1 : l > a.axisY.bounds.x2 ? a.axisY.bounds.x2 : l }
        }
    };
                ...
                if (0 < r.length) {
                    ...
                    for (m = 0; m < r.length; m++)
                        if (b = r[m].x.getTime ? r[m].x.getTime() : r[m].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[m].y) {
                            ...
                            b = q.dataPointIds[m];
                            this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: e, dataPointIndex: m, x1: y, y1: v, x2: h, y2: A };
                            b = G(b);
                            w && O(this._eventManager.ghostCtx, y, v, h, A, b, 0, null, !1, !1, !1, !1);
                            (r[m].indexLabel || q.indexLabel || r[m].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar100", dataPoint: r[m], dataSeries: q, point: { x: 0 <= r[m].y ? h : y, y: d }, direction: 0 > r[m].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(y, h), y1: v, x2: Math.max(y, h), y2: A }, color: b })
                        }
                }
            }
            c.restore();
    ...
    z.prototype.renderArea = function(a) {
        ...
        function d() { J && (0 < e.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? x = A : 0 > a.axisY.viewportMaximum ? x = m.y1 : 0 < a.axisY.viewportMinimum && (x = k.y2), f.lineTo(s, x), f.lineTo(J.x, x), f.closePath(), f.globalAlpha = e.fillOpacity, f.fill(), f.globalAlpha = 1, w && (g.lineTo(s, x), g.lineTo(J.x, x), g.closePath(), g.fill()), f.beginPath(), f.moveTo(s, y), g.beginPath(), g.moveTo(s, y), J = { x: s, y: y }) }
                        ...
                        if (v = q[r].x.getTime ? q[r].x.getTime() : q[r].x, !(v < a.axisX.dataInfo.viewPortMin ||
                            ...
                            if ("number" !== typeof q[r].y) e.connectNullData || (Y || c) || d(), Y = !0;
                                ...
                                c || Y ? (!c && e.connectNullData ? (f.setLineDash && (e.options.nullDataLineDashType || b === e.lineDashType && e.lineDashType !== e.nullDataLineDashType) && (c = s, b = y, s = p.x, y = p.y, d(), f.moveTo(p.x, p.y), s = c, y = b, J = p, b = e.nullDataLineDashType, f.setLineDash(B)), f.lineTo(s, y), w && g.lineTo(s, y)) : (f.beginPath(), f.moveTo(s, y), w && (g.beginPath(),
                                    g.moveTo(s, y)), J = { x: s, y: y }), Y = c = !1) : (f.lineTo(s, y), w && g.lineTo(s, y), 0 == r % 250 && d());
                                p = { x: s, y: y };
                                ...
                                this._eventManager.objectMap[I] = { id: I, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: r, x1: s, y1: y };
                                0 !== q[r].markerSize && (0 <
                                    q[r].markerSize || 0 < e.markerSize) && (v = e.getMarkerProperties(r, s, y, f), h.push(v), I = G(I), w && h.push({ x: s, y: y, ctx: g, type: v.type, size: v.size, color: I, borderColor: I, borderThickness: v.borderThickness }));
                                (q[r].indexLabel || e.indexLabel || q[r].indexLabelFormatter || e.indexLabelFormatter) && this._indexLabels.push({ chartType: "area", dataPoint: q[r], dataSeries: e, point: { x: s, y: y }, direction: 0 > q[r].y === a.axisY.reversed ? 1 : -1, color: t })
                            }
                    d();
                    P.drawMarkers(h)
                }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                var h = a.dataSeriesIndexes[m],
                    ...
                    p = l.dataPoints,
                    k = l.id;
                this._eventManager.objectMap[k] = { objectType: "dataSeries", dataSeriesIndex: h };
                k = G(k);
                d.fillStyle = k;
                var k = [],
                    n = 0,
                    ...
                    for (q = !1; n < p.length; n++)
                        if (e = p[n].x.getTime ? p[n].x.getTime() : p[n].x, !(e < a.axisX.dataInfo.viewPortMin || e > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !q)))
                            if ("number" !== typeof p[n].y) 0 < n && !q && (l.connectNullData ?
                                ...
                                this._eventManager.objectMap[B] = { id: B, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: n, x1: e, y1: q };
                                v[v.length] = { x: e, y: q };
                                ...
                                if (0 !== p[n].markerSize && (0 < p[n].markerSize || 0 < l.markerSize)) {
                                    ...
                                    k.push(X);
                                    B = G(B);
                                    w && k.push({ x: e, y: q, ctx: d, type: X.type, size: X.size, color: B, borderColor: B, borderThickness: X.borderThickness })
    ...
    z.prototype.renderStepArea = function(a) {
        ...
        function d() {
            t && (0 < e.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? x = A : 0 > a.axisY.viewportMaximum ?
                x = m.y1 : 0 < a.axisY.viewportMinimum && (x = k.y2), f.lineTo(s, x), f.lineTo(t.x, x), f.closePath(), f.globalAlpha = e.fillOpacity, f.fill(), f.globalAlpha = 1, w && (g.lineTo(s, x), g.lineTo(t.x, x), g.closePath(), g.fill()), f.beginPath(), f.moveTo(s, y), g.beginPath(), g.moveTo(s, y), t = { x: s, y: y })
        }
        var f = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var g = this._eventManager.ghostCtx,
                    ...
                    for (; r < q.length; r++)
                        if (v = q[r].x.getTime ? q[r].x.getTime() : q[r].x, !(v < a.axisX.dataInfo.viewPortMin || v > a.axisX.dataInfo.viewPortMax && (!e.connectNullData || !b))) {
                            ...
                            "number" !== typeof q[r].y ? (e.connectNullData || (b || c) || d(), b = !0) : (s = a.axisX.convertValueToPixel(v), y = a.axisY.convertValueToPixel(q[r].y),
                                ...
                                })), (q[r].indexLabel || e.indexLabel || q[r].indexLabelFormatter || e.indexLabelFormatter) && this._indexLabels.push({ chartType: "stepArea", dataPoint: q[r], dataSeries: e, point: { x: s, y: y }, direction: 0 > q[r].y === a.axisY.reversed ? 1 : -1, color: u }))
                        }
                    d();
                    P.drawMarkers(h)
                }
            ...
            f.restore();
            w && this._eventManager.ghostCtx.restore();
            return { source: f, dest: this.plotArea.ctx, animationCallback: F.xClipAnimation, easingFunction: F.easing.linear, animationBase: 0 }
        }
    };
                ...
                for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    if (0 < h.length) {
                        ...
                        for (var Y = !0, p = 0; p < h.length; p++) {
                            q = h[p];
                            var I = null,
                                I = 0 <= t.dataPointIndexes[q] ? u[t.dataPointIndexes[q]] : { x: q, y: null };
                            if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !Y)))
                                if ("number" !== typeof I.y) t.connectNullData || (Y || v) || c(), Y = !0;
                                    ...
                                    if (0 <= t.dataPointIndexes[q]) {
                                        ...
                                        this._eventManager.objectMap[ha] = { id: ha, objectType: "dataPoint", dataSeriesIndex: x, dataPointIndex: t.dataPointIndexes[q], x1: n, y1: e }
                                    }
                                    0 <= t.dataPointIndexes[q] && 0 !== I.markerSize && (0 < I.markerSize || 0 < t.markerSize) && (q = t.getMarkerProperties(t.dataPointIndexes[q], n,
                                        e, b), f.push(q), markerColor = G(ha), w && f.push({ x: n, y: e, ctx: s, type: q.type, size: q.size, color: markerColor, borderColor: markerColor, borderThickness: q.borderThickness }));
                                    (I.indexLabel || t.indexLabel || I.indexLabelFormatter || t.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea", dataPoint: I, dataSeries: t, point: { x: n, y: e }, direction: 0 > u[p].y === a.axisY.reversed ? 1 : -1, color: d })
                                }
                        }
                        c();
                        b.moveTo(n, e);
    ...
    z.prototype.renderStackedArea100 = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                s = !0;
                d = u.id;
                this._eventManager.objectMap[d] = { objectType: "dataSeries", dataSeriesIndex: x };
                d = G(d);
                t.fillStyle = d;
                m = [];
                if (0 < h.length) {
                    ...
                    for (var Y = !0, p = 0; p < h.length; p++) {
                        q = h[p];
                        var I = null,
                            I = 0 <= u.dataPointIndexes[q] ? z[u.dataPointIndexes[q]] : { x: q, y: null };
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!u.connectNullData || !Y)))
                            if ("number" !== typeof I.y) u.connectNullData || (Y || s) || c(), Y = !0;
                                ...
                                s || Y ? (!s && u.connectNullData ? (b.setLineDash && (u.options.nullDataLineDashType || y === u.lineDashType && u.lineDashType !== u.nullDataLineDashType) && (s = m.pop(), y = m[m.length - 1], c(), b.moveTo(r.x, r.y), m.push(y), m.push(s), y = u.nullDataLineDashType, b.setLineDash(U)), b.lineTo(n, e), w && t.lineTo(n, e)) : (b.beginPath(), b.moveTo(n, e), w && (t.beginPath(), t.moveTo(n, e))), Y = s = !1) : (b.lineTo(n, e), w && t.lineTo(n, e), 0 == p % 250 &&
                                    (c(), b.moveTo(n, e), w && t.moveTo(n, e), m.push({ x: n, y: v - ha })));
                                r = { x: n, y: e };
                                p < z.length - 1 && (B !== (z[p].lineColor || D) || y !== (z[p].lineDashType || u.lineDashType)) && (c(), b.beginPath(), b.moveTo(n, e), m.push({ x: n, y: v - ha }), B = z[p].lineColor || D, b.strokeStyle = B, b.setLineDash && (z[p].lineDashType ? (y = z[p].lineDashType, b.setLineDash(H(y, u.lineThickness))) : (y = u.lineDashType, b.setLineDash(X))));
                                ...
                                0 <= u.dataPointIndexes[q] && 0 !== I.markerSize && (0 < I.markerSize || 0 < u.markerSize) && (q = u.getMarkerProperties(p, n, e, b), g.push(q), markerColor = G(Ha), w && g.push({ x: n, y: e, ctx: t, type: q.type, size: q.size, color: markerColor, borderColor: markerColor, borderThickness: q.borderThickness }));
    ...
    z.prototype.renderBubble = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                if (l = a.dataSeriesIndexes[h], p = this.data[l], n = p.dataPoints, 0 < n.length)
                    for (c.strokeStyle = "#4572A7 ", d = 0; d < n.length; d++)
                        if (f = n[d].getTime ? f = n[d].x.getTime() : f = n[d].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[d].y) {
                            ...
                            this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: l, dataPointIndex: d, x1: f, y1: g, size: r };
                            r = G(s);
            ...
            c.restore();
            w && this._eventManager.ghostCtx.restore();
            return { source: c, dest: this.plotArea.ctx, animationCallback: F.fadeInAnimation, easingFunction: F.easing.easeInQuad, animationBase: 0 }
        }
    };
                    ...
                    for (var p = 0, n = 0, d = 0; d < l.length; d++)
                        if (f = l[d].getTime ? f = l[d].x.getTime() : f = l[d].x, !(f < a.axisX.dataInfo.viewPortMin ||
                            ...
                            Math.sqrt((p - f) * (p - f) + (n - g) * (n - g)) < Math.min(e.size, 5) && l.length > Math.min(this.plotArea.width, this.plotArea.height) || (p = h.dataPointIds[d], this._eventManager.objectMap[p] = {
                                ...
                                x1: f,
                                y1: g
                            }, p = G(p), w && P.drawMarker(e.x, e.y, this._eventManager.ghostCtx, e.type, e.size, p, p, e.borderThickness), (l[d].indexLabel || h.indexLabel || l[d].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({ chartType: "scatter", dataPoint: l[d], dataSeries: h, point: { x: f, y: g }, direction: 1, bounds: { x1: f - e.size / 2, y1: g - e.size / 2, x2: f + e.size / 2, y2: g + e.size / 2 }, color: null }), p = f, n = g)
                        }
                }
            }
            c.restore();
                    ...
                    for (var t = 5 < n && r.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)
                        if (s[f].getTime ? p = s[f].x.getTime() : p = s[f].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax) && null !== s[f].y && s[f].y.length && "number" === typeof s[f].y[0] && "number" === typeof s[f].y[1] && "number" === typeof s[f].y[2] && "number" === typeof s[f].y[3]) {
                            ...
                            var v = g - n / 2 << 0,
                                ...
                                u = 0 === x % 2 ? 0 : 0.5,
                                z = r.dataPointIds[f];
                            this._eventManager.objectMap[z] = { id: z, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: v, y1: k, x2: A, y2: m, x3: g, y3: h, x4: g, y4: l, borderThickness: x, color: d };
                            c.strokeStyle = d;
                            c.beginPath();
                            c.lineWidth = x;
                            ...
                            (s[f].indexLabel || r.indexLabel || s[f].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                dataPoint: s[f],
                                dataSeries: r,
                                point: { x: v + (A - v) / 2, y: a.axisY.reversed ? h : m },
                                direction: 1,
                                bounds: {
                                    x1: v,
                                    y1: Math.min(m, h),
                ...
                if (0 < n.length)
                    for (var e = 5 < m && p.bevelEnabled ? !0 : !1, f = 0; f < n.length; f++)
                        if (n[f].getTime ? k = n[f].x.getTime() : k = n[f].x, !(k < a.axisX.dataInfo.viewPortMin ||
                            ...
                            s = p.dataPointIds[f];
                            this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: l, dataPointIndex: f, x1: q, y1: d, x2: r, y2: g };
                            ...
                            if (n[f].indexLabel || p.indexLabel || n[f].indexLabelFormatter || p.indexLabelFormatter) this._indexLabels.push({
                                ...
                                color: b
                            }), this._indexLabels.push({ chartType: "rangeColumn", dataPoint: n[f], dataSeries: p, indexKeyword: 1, point: { x: q + (r - q) / 2, y: n[f].y[1] >= n[f].y[0] ? d : g }, direction: n[f].y[1] >= n[f].y[0] ? 1 : -1, bounds: { x1: q, y1: Math.min(d, g), x2: r, y2: Math.max(d, g) }, color: b })
                        }
            }
            c.restore();
            w && this._eventManager.ghostCtx.restore();
                        ...
                        for (f = 0; f < e.length; f++)
                            if (e[f].getTime ? m = e[f].x.getTime() : m = e[f].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && null !== e[f].y && e[f].y.length && "number" === typeof e[f].y[0] && "number" === typeof e[f].y[1]) {
                                ...
                                if (e[f].indexLabel || n.indexLabel || e[f].indexLabelFormatter || n.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeBar", dataPoint: e[f], dataSeries: n, indexKeyword: 0, point: { x: e[f].y[1] >= e[f].y[0] ? d : g, y: k + (r - k) / 2 }, direction: e[f].y[1] >= e[f].y[0] ? -1 : 1, bounds: { x1: Math.min(d, g), y1: k, x2: Math.max(d, g), y2: r }, color: b }), this._indexLabels.push({
                                    ...
                                    bounds: { x1: Math.min(d, g), y1: k, x2: Math.max(d, g), y2: r },
                                    color: b
                                })
                            }
                    }
                        ...
                        if (s = l[n].x.getTime ? l[n].x.getTime() : l[n].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !E)))
                            if (null !== l[n].y && l[n].y.length && "number" === typeof l[n].y[0] && "number" === typeof l[n].y[1]) {
                                ...
                                p || E ? (h.connectNullData && !p ? (b.setLineDash && (h.options.nullDataLineDashType ||
                                    z === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (k[k.length - 1].newLineDashArray = D, z = h.nullDataLineDashType, b.setLineDash(B)), b.lineTo(e, q), w && d.lineTo(e, q), k.push({ x: e, y: r })) : (b.beginPath(), b.moveTo(e, q), t = { x: e, y: q }, k = [], k.push({ x: e, y: r }), w && (d.beginPath(), d.moveTo(e, q))), E = p = !1) : (b.lineTo(e, q), k.push({ x: e, y: r }), w && d.lineTo(e, q), 0 == n % 250 && c());
                                s = h.dataPointIds[n];
                                this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: n, x1: e, y1: q, y2: r };
                                n < l.length -
                                ...
                                if (0 !== l[n].markerSize && (0 < l[n].markerSize || 0 < h.markerSize)) {
                                    ...
                                    f.push(U);
                                    X = G(s);
                                    w && f.push({ x: e, y: q, ctx: d, type: U.type, size: U.size, color: X, borderColor: X, borderThickness: U.borderThickness })
                                }
                                if (l[n].indexLabel || h.indexLabel || l[n].indexLabelFormatter || h.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeArea", dataPoint: l[n], dataSeries: h, indexKeyword: 0, point: { x: e, y: q }, direction: l[n].y[0] > l[n].y[1] === a.axisY.reversed ? -1 : 1, color: v }), this._indexLabels.push({
                                    chartType: "rangeArea",
                                    dataPoint: l[n],
                                    dataSeries: h,
                                    indexKeyword: 1,
                    ...
                    for (n = !1; l < h.length; l++)
                        if (p = h[l].x.getTime ? h[l].x.getTime() : h[l].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !n)))
                            if (null !== h[l].y && h[l].y.length && "number" === typeof h[l].y[0] && "number" === typeof h[l].y[1]) {
                                ...
                                this._eventManager.objectMap[B] = { id: B, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: l, x1: p, y1: n, y2: e };
                                q[q.length] = { x: p, y: n };
                                r[r.length] = { x: p, y: e };
                                ...
                                if (0 !== h[l].markerSize && (0 < h[l].markerSize || 0 < m.markerSize)) {
                                    ...
                                    f.push(D);
                                    var E = G(B);
                                    w && f.push({ x: p, y: n, ctx: d, type: D.type, size: D.size, color: E, borderColor: E, borderThickness: D.borderThickness });
                                    D = m.getMarkerProperties(l, p, e, b);
                                    f.push(D);
                                    E = G(B);
                                    w && f.push({ x: p, y: e, ctx: d, type: D.type, size: D.size, color: E, borderColor: E, borderThickness: D.borderThickness })
                                }
                                if (h[l].indexLabel || m.indexLabel || h[l].indexLabelFormatter || m.indexLabelFormatter) this._indexLabels.push({
                                    ...
                                    color: s
                                }), this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: h[l], dataSeries: m, indexKeyword: 1, point: { x: p, y: e }, direction: h[l].y[0] <= h[l].y[1] ? 1 : -1, color: s });
                                n = !1
        ...
        function c() {
            if (l && p) {
                for (var a = 0, b = 0, c = 0, d = 0, f = 0; f < p.length; f++) {
                    var g = p[f],
                        m = l.dataPointIds[f],
                        k = { id: m, objectType: "dataPoint", dataPointIndex: f, dataSeriesIndex: 0 };
                    q.push(k);
            ...
            for (b = 0; b < p.length; b++) {
                ...
                if (d > c) {
                    var f = 0.07 * D * Math.cos(q[b].midAngle),
                        ...
                        m = !1;
                    if (p[b].exploded) { if (1E-9 < Math.abs(q[b].center.x - (x.x + f)) || 1E-9 < Math.abs(q[b].center.y - (x.y + g))) q[b].center.x = x.x + f * a, q[b].center.y = x.y + g * a, m = !0 } else if (0 < Math.abs(q[b].center.x - x.x) || 0 < Math.abs(q[b].center.y - x.y)) q[b].center.x = x.x + f * (1 - a), q[b].center.y = x.y + g * (1 - a), m = !0;
        ...
        function g(a, b, c) {
            ...
            if (0 <= a && a < p.length) {
                ...
                for (m = 1; m < p.length; m++)
                    if (h = (a - m + q.length) % q.length, q[h].hemisphere !== q[a].hemisphere) { h = null; break } else if (q[h].indexLabelText && q[h].hemisphere === q[a].hemisphere && h !== a && (0 > d(q[h], q[a]) ||
    ...
    z.prototype.requestAnimFrame = function() { return window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(a) { window.setTimeout(a, 1E3 / 60) } }();
    ...
    z.prototype.set = function(a, c, b) { b = "undefined" === typeof b ? !0 : b; "options" === a ? (this.options = c, b && this.render()) : z.base.set.call(this, a, c, b) };
    ...
    z.prototype.print = function() {
        ...
        setTimeout(function() {
            d.focus();
            d.print();
            setTimeout(function() { b._canvasJSContainer.removeChild(c) }, 1E3)
        }, 500)
    };
    la.prototype.registerSpace = function(a, c) { "top" === a ? this._topOccupied += c.height : "bottom" === a ? this._bottomOccupied += c.height : "left" === a ? this._leftOccupied += c.width : "right" === a && (this._rightOccupied += c.width) };
    ...
    la.prototype.getFreeSpace = function() { return { x1: this._x1 + this._leftOccupied, y1: this._y1 + this._topOccupied, x2: this._x2 - this._rightOccupied, y2: this._y2 - this._bottomOccupied, width: this._x2 - this._x1 - this._rightOccupied - this._leftOccupied, height: this._y2 - this._y1 - this._bottomOccupied - this._topOccupied } };
    la.prototype.reset = function() { this._rightOccupied = this._leftOccupied = this._bottomOccupied = this._topOccupied = this._padding };
    T(W, K);
    W.prototype.render =
        function(a) {
            if (0 !== this.fontSize) {
    ...
    pa.prototype.render = function() {
        if (this.text) {
            ...
            g.horizontalAlign = m;
            g.render(!0);
            a.layoutManager.registerSpace(h, { width: this.width + ("left" === h || "right" === h ? this.margin + 2 : 0), height: this.height + ("top" === h || "bottom" === h ? this.margin + 2 : 0) });
            this.bounds = {
                x1: b,
                y1: d,
                x2: b + this.width,
    ...
    za.prototype.render = function() {
            ...
            if (n.dataPoints && n.dataPoints.length)
                if ("pie" !== n.type && "doughnut" !== n.type &&
                    ...
                    var e = n.legendMarkerType = n.legendMarkerType ? n.legendMarkerType : "line" !== n.type && "stepLine" !== n.type && "spline" !== n.type && "scatter" !== n.type && "bubble" !== n.type || !n.markerType ? ca.getDefaultLegendMarker(n.type) : n.markerType,
                        q = n.legendText ? n.legendText : this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: n, dataPoint: null }) : n.name,
                    ...
                    for (var w = 0; w < n.dataPoints.length; w++) {
                        var x = n.dataPoints[w],
                            ...
                            q = x.legendText ? x.legendText : n.legendText ? n.legendText : this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: n, dataPoint: x }) : x.name ? x.name : "DataPoint: " + (w + 1),
        ...
        this.items = h;
        for (p = 0; p < this.items.length; p++) e = h[p], e.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[e.id] = { id: e.id, objectType: "legendItem", legendItemIndex: p, dataSeriesIndex: e.dataSeriesIndex, dataPointIndex: e.dataPointIndex };
            ...
            if (0 <= g && g < this.dataPoints.length) {
                ...
                if (e) {
                    switch (this.type) {
                        ...
                        case "rangeColumn":
                        case "rangeBar":
                            a >= e.x1 && (a <= e.x2 && c >= e.y1 && c <= e.y2) && (d.push({ dataPoint: q, dataPointIndex: g, dataSeries: this, distance: Math.min(Math.abs(e.x1 - a), Math.abs(e.x2 - a), Math.abs(e.y1 - c), Math.abs(e.y2 - c)) }), m = !0);
                            break;
                        case "line":
                        case "stepLine":
                        case "spline":
                        ...
                        case "bubble":
                            s = e.size;
                            r = Math.sqrt(Math.pow(e.x1 - a, 2) + Math.pow(e.y1 - c, 2));
                            r <= s / 2 && (d.push({ dataPoint: q, dataPointIndex: g, dataSeries: this, distance: r }), m = !0);
                            break;
                        case "pie":
                        case "doughnut":
                            s = e.center;
                            ...
                            r < e.radius && r > t && (r = Math.atan2(c - s.y, a - s.x), 0 > r && (r += 2 * Math.PI), r = Number(((180 * (r / Math.PI) % 360 + 360) % 360).toFixed(12)), s = Number(((180 * (e.startAngle / Math.PI) % 360 +
                                360) % 360).toFixed(12)), t = Number(((180 * (e.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === t && 1 < e.endAngle && (t = 360), s >= t && 0 !== q.y && (t += 360, r < s && (r += 360)), r > s && r < t && (d.push({ dataPoint: q, dataPointIndex: g, dataSeries: this, distance: 0 }), m = !0));
                            break;
                        case "candlestick":
    ...
    B.prototype.createLabels = function() {
        ...
        if ("axisX" === this.type && b && !this.logarithmic)
            ...
            if (this.logarithmic && !this.equidistantInterval) {
                ...
                for (var e = 0; e < this.logLabelValues.length; e++) b = this.logLabelValues[e], b < this.viewportMinimum || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: b, label: this.labels[b] ? this.labels[b] : null }) : "axisX" === this.type && this.labels[b] ?
        ...
        if (this.labelAutoFit || this.options.labelAutoFit)
            if (u(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position)
                if (g = 0.9 * h >> 0, n = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                    ...
                    for (b = 0; b < this._labels.length; b++) { a = this._labels[b].textBlock; for (var r, s = a.text.split(" "), d = 0; d < s.length; d++) e = s[d], this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, e = this.ctx.measureText(e), e.width > n && (r = b, n = e.width) }
                    b = 0;
            ...
            for (; 4 > q;) {
                ...
                if (a && 0 < a.length)
                    for (e = 0; e < a.length; e++) a[e] && (a[e].lineCoordinates.x1 = k, h = Math.round(g.x2 - S - R > p.width - 10 ? p.width - 10 : g.x2 - S - R), a[e]._labels && 1 < a[e]._labels.length && (m = l = 0, l = a[e]._labels[1], m = "dateTime" === a[e].chart.plotInfo.axisXValueType ? a[e]._labels[a[e]._labels.length - 2] : a[e]._labels[a[e]._labels.length - 1], r = l.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(l.textBlock.angle)) + (l.textBlock.height -
                        ...
                        a[e].lineCoordinates.x2 = h, a[e].lineCoordinates.width = h - k, a[e].lineCoordinates.y1 = m, a[e].lineCoordinates.y2 = m, a[e].bounds = { x1: k, y1: m, x2: h, y2: l - (Z + f - t[e] - M), width: h - k, height: l - m }), M += t[e] + a[e].margin;
                if (c && 0 < c.length)
                    for (e = 0; e < c.length; e++) c[e].lineCoordinates.x1 = Math.round(g.x1 + T + C), c[e].lineCoordinates.x2 = Math.round(g.x2 - S - R > p.width - 10 ? p.width - 10 : g.x2 - S - R), c[e].lineCoordinates.width = Math.abs(h - k), c[e]._labels && 1 < c[e]._labels.length && (l = c[e]._labels[1], m = "dateTime" === c[e].chart.plotInfo.axisXValueType ?
                        ...
                        l = Math.round(g.y2 + c[e].margin), c[e].lineCoordinates.y1 = m + V + $ - P, c[e].lineCoordinates.y2 = m, c[e].bounds = { x1: k, y1: m + (V + $ - v[e] - P), x2: h, y2: l, width: h - k, height: l - m }, P += v[e] + c[e].margin;
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++) C = 10, b[e] && (k = Math.round(a[0] ? a[0].lineCoordinates.x1 : c[0].lineCoordinates.x1), C = b[e]._labels && 0 < b[e]._labels.length ? b[e]._labels[b[e]._labels.length - 1].textBlock.height / 2 : 10, m = Math.round(g.y1 + V + $ < Math.max(C, 10) ? Math.max(C, 10) : g.y1 + V + $), h = Math.round(a[0] ? a[0].lineCoordinates.x1 : c[0].lineCoordinates.x1),
                        C = 0 < a.length ? 0 : b[e]._labels && 0 < b[e]._labels.length ? b[e]._labels[0].textBlock.height / 2 : 10, l = Math.round(g.y2 - Z - f - C), b[e].lineCoordinates = { x1: h - Q, y1: m, x2: h - Q, y2: l, height: Math.abs(l - m) }, b[e].bounds = { x1: k - (w[e] + Q), y1: m, x2: h, y2: l, width: h - k, height: l - m }, b[e].title && (b[e]._titleTextBlock.maxWidth = 0 < b[e].titleMaxWidth && b[e].titleMaxWidth < b[e].lineCoordinates.height ? b[e].titleMaxWidth : b[e].lineCoordinates.height), Q += w[e] + b[e].margin);
                if (d && 0 < d.length)
            ...
            for (; 4 > q;) {
                ...
                if (a && 0 < a.length)
                    for (e = 0; e < a.length; e++) {
                        ...
                        a[e].lineCoordinates = { x1: h - O, y1: m, x2: h - O, y2: l, height: Math.abs(l - m) };
                        a[e].bounds = { x1: h - (D[e] + O), y1: m, x2: h, y2: l, width: h - k, height: l - m };
                ...
                if (c && 0 < c.length)
                    for (e = 0; e < c.length; e++) {
                        ...
                        c[e].lineCoordinates = { x1: h + Q, y1: m, x2: h + Q, y2: l, height: Math.abs(l - m) };
                        c[e].bounds = { x1: k, y1: m, x2: h + r[e] + Q, y2: l, width: h - k, height: l - m };
    ...
    B.prototype.renderStripLinesOfThicknessType = function(a) {
        if (this.stripLines && 0 < this.stripLines.length && a) {
            ...
            if (k)
                for (k = !1, d = 0; d < h.length; d++) b = h[d], b.stripLine.showOnTop ? k || (k = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() { for (f = 0; f < h.length; f++) b = h[f], "outside" === b.stripLine.labelPlacement && b.stripLine.showOnTop && b.textBlock.render(!0) }, b.textBlock)) : "outside" ===
    ...
    B.prototype.convertValueToPixel = function(a) { return this.logarithmic ? this.conversionParameters.reference + this.conversionParameters.pixelPerUnit * Math.log(a / this.conversionParameters.minimum) / this.conversionParameters.lnLogarithmBase + 0.5 << 0 : this.conversionParameters.reference + this.conversionParameters.pixelPerUnit * (a - this.conversionParameters.minimum) + 0.5 << 0 };
    ...
    B.prototype.getXValueAt = function(a) { if (!a) return null; var c = null; "left" === this._position ? c = this.convertPixelToValue(a.y) : "bottom" === this._position && (c = this.convertPixelToValue(a.x)); return c };
    ...
    qa.prototype.render = function() {
        ...
        if (0 < c) {
            ...
            if ("bottom" === this.parent._position || "top" === this.parent._position) f = g = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, k = this.chart.plotArea.y1, m = this.chart.plotArea.y2, this.bounds = { x1: f - c / 2, y1: k, x2: g + c / 2, y2: m };
            else if ("left" === this.parent._position || "right" === this.parent._position) k = m = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, f = this.chart.plotArea.x1, g = this.chart.plotArea.x2, this.bounds = { x1: f, y1: k - c / 2, x2: g, y2: m + c / 2 };
            this.ctx.moveTo(f, k);
            this.ctx.lineTo(g,
                m);
            this.ctx.stroke();
    ...
    R.prototype.mouseMoveHandler =
        function(a, c) { this._lastUpdated && 40 > (new Date).getTime() - this._lastUpdated || (this._lastUpdated = (new Date).getTime(), this._updateToolTip(a, c)) };
            ...
            if (this.shared &&
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if (this.chart.axisX)
                        for (var m = 0; m < this.chart.axisX.length; m++) {
                            for (var k = this.chart.axisX[m].convertPixelToValue({ y: c }), h = null, d = 0; d < this.chart.axisX[m].dataSeries.length; d++)(h = this.chart.axisX[m].dataSeries[d].getDataPointAtX(k, b)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[m].dataSeries[d], null !== h.dataPoint.y && f.push(h));
                            h = null
                        }
                    if (this.chart.axisX2)
                        for (m = 0; m < this.chart.axisX2.length; m++) {
                            k =
                                this.chart.axisX2[m].convertPixelToValue({ y: c });
                            h = null;
                    ...
                    if (this.chart.axisX)
                        for (m = 0; m < this.chart.axisX.length; m++)
                            for (k = this.chart.axisX[m].convertPixelToValue({ x: a }), h = null, d = 0; d < this.chart.axisX[m].dataSeries.length; d++)(h = this.chart.axisX[m].dataSeries[d].getDataPointAtX(k,
                                b)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[m].dataSeries[d], null !== h.dataPoint.y && f.push(h));
                    if (this.chart.axisX2)
                        for (m = 0; m < this.chart.axisX2.length; m++)
                            for (k = this.chart.axisX2[m].convertPixelToValue({ x: a }), h = null, d = 0; d < this.chart.axisX2[m].dataSeries.length; d++)(h = this.chart.axisX2[m].dataSeries[d].getDataPointAtX(k, b)) && 0 <= h.index && (h.dataSeries = this.chart.axisX2[m].dataSeries[d], null !== h.dataPoint.y && f.push(h))
                }
                if (0 === f.length) return;
                f.sort(function(a, b) { return a.distance - b.distance });
                b = f[0];
                ...
                if (0 <= this.currentSeriesIndex) {
                    ...
                    if (0 <= this.currentDataPointIndex) d = f.dataPoints[this.currentDataPointIndex], h.dataSeries = f, h.dataPoint = d, h.index = this.currentDataPointIndex, h.distance = Math.abs(d.x - k);
                        ...
                        k = f.axisX.convertPixelToValue({ x: a });
    ...
    R.prototype.getToolTipInnerHTML = function(a) {
        ...
        for (var c = null, b = null, d = null, f = 0, g = "", k = !0, m = 0; m < a.length; m++)
            if (a[m].dataSeries.toolTipContent || a[m].dataPoint.toolTipContent) { k = !1; break }
        if (k && (this.content && "function" === typeof this.content || this.contentFormatter)) a = { chart: this.chart, toolTip: this.options, entries: a }, c = this.contentFormatter ? this.contentFormatter(a) : this.content(a);
    ...
    R.prototype.hide = function(a) { this.container && (this.container.style.display = "none", this.currentSeriesIndex = -1, this._prevY = this._prevX = NaN, ("undefined" === typeof a || a) && this.chart.resetOverlayedCanvas()) };
    R.prototype.show = function(a, c, b) { this._updateToolTip(a, c, "undefined" === typeof b ? !1 : b) };
    ...
    oa.prototype.getNewObjectTrackingId = function() { return ++this.lastObjectId };
        ...
        if ("mousemove" === a.type || "click" === a.type) {
            ...
            if ((d = this.chart.getObjectAtXY(b.x, b.y, !1)) && "undefined" !== typeof this.objectMap[d])
                if (d = this.objectMap[d], "dataPoint" === d.objectType) {
                    var f = this.chart.data[d.dataSeriesIndex],
                        ...
                        k = d.dataPointIndex;
                    d.eventParameter = { x: b.x, y: b.y, dataPoint: g, dataSeries: f.options, dataPointIndex: k, dataSeriesIndex: f.index, chart: this.chart };
                    d.eventContext = { context: g, userContext: g, mouseover: "mouseover", mousemove: "mousemove", mouseout: "mouseout", click: "click" };
                    c.push(d);
            ...
            for (b = 0; b < this.mouseoveredObjectMaps.length; b++) {
                ...
                for (d = 0; d < c.length; d++)
                    if (c[d].id === this.mouseoveredObjectMaps[b].id) { g = !1; break }
            ...
            for (b = 0; b < c.length; b++) {
                ...
                for (d = 0; d < this.mouseoveredObjectMaps.length; d++)
                    if (c[b].id === this.mouseoveredObjectMaps[d].id) { f = !0; break }
    ...
    var F = {
            ...
            easing: { linear: function(a, c, b, d) { return b * a / d + c }, easeOutQuad: function(a, c, b, d) { return -b * (a /= d) * (a - 2) + c }, easeOutQuart: function(a, c, b, d) { return -b * ((a = a / d - 1) * a * a * a - 1) + c }, easeInQuad: function(a, c, b, d) { return b * (a /= d) * a + c }, easeInQuart: function(a, c, b, d) { return b * (a /= d) * a * a * a + c } }
        },
        P = {
        ...
        da = {
            Chart: z,
            addColorSet: function(a, c) { ja[a] = c },
            addCultureInfo: function(a, c) { sa[a] = c },
            ...
            formatDate: function(a, c, b) { b = b || "en"; if (sa[b]) return Ga(a, c || "DD MMM YYYY", new ra(b)); throw "Unknown Culture Name"; }
        };
